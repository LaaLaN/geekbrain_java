...
public class lesson2 {
    ...
    public static void main(String[] args) {
        ...
        {
            //Arrays.fill(array01[i], (byte) 1); //не работает как в уроке
        ...
        {
            if (array03[i] < 6) array03[i] *= 2;
        } //если елемент меньше 6 то умножаем на 2 и переназначаем
        ...
        showArrayInt(array2);
        System.out.println("Введите число на которое нужно сдвинуть элементы (положительное число сдвинет элементы вправо): ");
